{
    ...
    "assets": {
        "web.assets_backend": [
            ...
            # Route Board (Phase 2b)
            "hlv_warehouse_monitor/static/src/components/route_board/route_board.scss",
            "hlv_warehouse_monitor/static/src/components/route_board/route_board.xml",
