...
# Field do Studio tạo trên bản cài này, không có trong mã nguồn Odoo. Đọc bằng getattr
# qua ``_fields`` để module vẫn cài được ở nơi chưa tạo các field đó.
STUDIO_ADDRESS_FIELD = 'x_studio_a_ch_giao_hng'
STUDIO_AMOUNT_FIELD = 'x_studio_ng_tin_sau_thu'
...
class StockPicking(models.Model):
    ...
    def _vtracking_amount(self):
        ...
        Trả về 0.0 khi bản cài chưa có field đó.
        """
        self.ensure_one()
