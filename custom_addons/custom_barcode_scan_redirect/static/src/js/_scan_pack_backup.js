/* ============================================================
 * scan_pack.js — Pack Scan UI Controller
 * ============================================================
 * TABLE OF CONTENTS
 * -----------------
 * §1  TOAST NOTIFICATION SYSTEM        (line ~10)
 * §2  MAIN DOM-READY HANDLER           (line ~35)
 ...
 *     §2.10 Page init (focus, diag, recording)
 * §3  UPLOAD SESSION MANAGEMENT         (chunked upload)
 * §4  SERVER SYNC HELPERS               (applyServerSyncInfo)
 * §5  RECORDING MODULE                  (MediaRecorder + upload)
 * §6  UI UTILITIES                      (createModal, optimizePackageUI)
 * §7  SIBLING PACK ACTIONS              (unpack / edit cards)
 * §8  PACKAGE EDIT MODAL                (open, update, remove, add, transfer)
 * §9  TRANSFER MODAL                    (between packages)
 * §10 SIDE PANEL UI                     (toggle, updateSidePanelUI)
 * ============================================================ */
...
// §3 ==================== UPLOAD SESSION MANAGEMENT (CHUNKED) ====================
let uploadId = null;
let chunkIndex = 0;
let finishing = false;
