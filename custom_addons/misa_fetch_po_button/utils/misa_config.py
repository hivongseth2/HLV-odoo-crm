...
class MisaConfig(models.AbstractModel):
    ...
    def get_crm_sale_order_detail_payload(self,id):
        ...
        return {
            "Columns": "",
            "Sorts": [],
            "Start": 0,
            "Page": 1,
            "PageSize": 20,
