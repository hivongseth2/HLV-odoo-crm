    ...
    def _compute_display_qty_html(self):
        for line in self:
            ...
            if line.actual_qty:
                ...
                line.display_qty_html = Markup(f"<div>{qty_str}</div><div style='font-size: 0.85rem; color: #888888; font-weight: bold; font-style: italic;'>thực: {act_qty_str}</div>")
            else:
    ...
    def _compute_display_price_unit_html(self):
        for line in self:
            ...
            if line.actual_qty:
                ...
                line.display_price_unit_html = Markup(f"<div>{price_str}</div><div style='font-size: 0.85rem; color: #888888; font-weight: bold; font-style: italic;'>thực: {act_price_str}</div>")
            else:
    ...
    def _compute_display_tax_rate_html(self):
        for line in self:
            ...
            if line.actual_qty:
                ...
                line.display_tax_rate_html = Markup(f"<div>{tax_str}%</div><div style='font-size: 0.85rem; color: #888888; font-weight: bold; font-style: italic;'>thực: {act_tax_str}%</div>")
            else:
    ...
    def _compute_display_discount_rate_html(self):
        for line in self:
            ...
            if line.actual_qty:
                ...
                line.display_discount_rate_html = Markup(f"<div>{discount_str}%</div><div style='font-size: 0.85rem; color: #888888; font-weight: bold; font-style: italic;'>thực: {act_discount_str}%</div>")
            else:
    ...
    def _compute_display_supplier_html(self):
        for line in self:
            ...
            if line.actual_qty:
                ...
                line.display_supplier_html = Markup(f"<div>{supplier_name}</div><div style='font-size: 0.85rem; color: #888888; font-weight: bold; font-style: italic;'>thực: {act_supplier_name}</div>")
            else:
