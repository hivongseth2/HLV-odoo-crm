# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'report/pxbh_khachle_khonghd_combo.xml',
        'report/pxbh_khachle_khonghd_a5_combo.xml',
        'report/px_hlv_a4_combo.xml',
        'report/px_hlv_a5_combo.xml',
        'report/bbgn_a5_khong_gia_combo.xml',
        'report/bbgn_a4_khong_gia_combo.xml',
        'report/bbgn_a4_khongngay_combo.xml',
        'report/bbgn_a5_khongngay_combo.xml',
        'report/bbbg_a4_co_po_combo.xml',
        'report/bbbg_a5_co_po_combo.xml',
    ],
}