# -*- coding: utf-8 -*-
"""Đánh dấu quyền của người gửi trong nội dung gửi cho OpenAI.

Util thuần: không đụng ``self.env``, không side effect.

Marker do hệ thống chèn là căn cứ DUY NHẤT để AI biết ai là quản trị viên. Người dùng
Zalo hoàn toàn có thể tự gõ một chuỗi giống hệt vào tin nhắn, nên mọi marker có sẵn
trong nội dung người dùng phải bị xóa trước khi chèn marker thật.
"""
import re
