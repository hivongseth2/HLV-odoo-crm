...
- Không cho xóa `mail.message` đã gắn với chatter của chứng từ/liên hệ. Addon chặn cả `unlink()` lẫn luồng Odoo 18 cập nhật message thành rỗng, đồng thời ẩn nút Xóa trong chatter. Tin nhắn Discuss không bị ảnh hưởng.
