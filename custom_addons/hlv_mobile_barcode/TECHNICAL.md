...
- **Bố cục 1 cột tối ưu hợp nhất (Unified 1-Column Layout)**: Giữ nguyên giao diện 1 cột đứng thẳng cực kỳ gọn gàng và đồng bộ cho cả Mobile lẫn Desktop. Dải camera nằm ngang được cấu hình cao `160px` trên cả hai nền tảng giúp tăng đáng kể góc quét và tạo tính cân đối khi sử dụng trên màn hình lớn.
